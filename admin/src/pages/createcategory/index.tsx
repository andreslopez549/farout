...
const NewProductPage: NextPage<NewProductPageProps> = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const createproduct = categoryService.createcategory(formData).then(res => {
      if (res.status == true) {
  ...
  return (
    <AdminLayout>
      <CustomModal show={showSuccessModal} message={successMessage} onClose={() => {router.push('/categories')}} />
      <Card>
