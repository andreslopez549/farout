...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavItem icon={faCode} href="/products">
       Products
        {/* <small className="ms-auto"><Badge bg="danger" className="ms-auto">DEMO</Badge></small> */}
      </SidebarNavItem>
      <SidebarNavItem icon={faCode} href="/categories">
       Categories
        {/* <small className="ms-auto"><Badge bg="danger" className="ms-auto">DEMO</Badge></small> */}
      </SidebarNavItem>
      <SidebarNavItem icon={faCode} href="/brands">
       Brands
        {/* <small className="ms-auto"><Badge bg="danger" className="ms-auto">DEMO</Badge></small> */}
      </SidebarNavItem>
      <SidebarNavItem icon={faCode} href="/attributes">
       Attributes
        {/* <small className="ms-auto"><Badge bg="danger" className="ms-auto">DEMO</Badge></small> */}
      </SidebarNavItem>
